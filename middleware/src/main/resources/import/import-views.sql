...
INSERT INTO DISCOVERY_VIEW_TEMPLATES (DISCOVERY_VIEW_ID, KEY, TEMPLATE) VALUES (2, 'default', '<div style="display: flex"> <span>{{title}}</span> <span style="margin-left: 5px">|</span> <span style="margin-left: 5px">{{type}}</span></div><div style="display: flex; margin-top: 10px;"> {{#doi}} <span style="margin-right: 5px" class="altmetric-embed" data-hide-less-than="1" data-badge-popover="right" data-doi="{{doi}}"></span> <span style="margin-right: 5px" class="__dimensions_badge_embed__" data-hide-zero-citations="true" data-style="small_rectangle" data-legend="hover-right" data-doi="{{doi}}"></span> {{/doi}}</div>');
