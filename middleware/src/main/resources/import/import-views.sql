...
INSERT INTO DIRECTORY_VIEW_TEMPLATES (DIRECTORY_VIEW_ID, KEY, TEMPLATE) VALUES (1, 'default', '<div style="display: flex"><div style="margin-right: 25px"><div>{{#thumbnail}}<img src="https://scholars.library.tamu.edu/vivo{{thumbnail}}" style="border-radius: 50%" height="60" width="60">{{/thumbnail}}{{^thumbnail}}<img src="assets/images/default-avatar.png" style="border-radius: 50%" height="60" width="60">{{/thumbnail}}</div></div><div style="margin: auto 0"><div><a href="/display/{{collection}}/{{id}}">{{name}}</a></div><div><span>{{preferredTitle}}</span></div></div></div>');
...
INSERT INTO DISCOVERY_VIEW_SORT (DISCOVERY_VIEW_ID, DIRECTION, FIELD) VALUES (1, 'ASC', 'name');
INSERT INTO DISCOVERY_VIEW_SORT (DISCOVERY_VIEW_ID, DIRECTION, FIELD) VALUES (2, 'ASC', 'title');
INSERT INTO DISCOVERY_VIEW_SORT (DISCOVERY_VIEW_ID, DIRECTION, FIELD) VALUES (3, 'ASC', 'title');
INSERT INTO DISCOVERY_VIEW_SORT (DISCOVERY_VIEW_ID, DIRECTION, FIELD) VALUES (4, 'ASC', 'title');
INSERT INTO DISCOVERY_VIEW_SORT (DISCOVERY_VIEW_ID, DIRECTION, FIELD) VALUES (5, 'ASC', 'title');
INSERT INTO DISCOVERY_VIEW_SORT (DISCOVERY_VIEW_ID, DIRECTION, FIELD) VALUES (6, 'ASC', 'name');
...
INSERT INTO DISPLAY_VIEWS (ID, NAME, COLLECTION, LEFT_SCAN_TEMPLATE, MAIN_CONTENT_TEMPLATE, RIGHT_SCAN_TEMPLATE, TYPE) VALUES (1, 'People', 'persons', '<div>Left Scan</div>', '<div>Main Content</div>', '<div>Right Scan</div>', 'FacultyMember')

INSERT INTO TAB_VIEWS (ID, NAME, HIDDEN, DISPLAY_VIEW_ID) VALUES (1, 'Academic Background', false, 1)
INSERT INTO TAB_VIEWS (ID, NAME, HIDDEN, DISPLAY_VIEW_ID) VALUES (2, 'Publications', false, 1)
INSERT INTO TAB_VIEWS (ID, NAME, HIDDEN, DISPLAY_VIEW_ID) VALUES (3, 'Grants/Awards', false, 1)
INSERT INTO TAB_VIEWS (ID, NAME, HIDDEN, DISPLAY_VIEW_ID) VALUES (4, 'Recent Courses', false, 1)
INSERT INTO TAB_VIEWS (ID, NAME, HIDDEN, DISPLAY_VIEW_ID) VALUES (5, 'Identity', true, 1)
INSERT INTO TAB_VIEWS (ID, NAME, HIDDEN, DISPLAY_VIEW_ID) VALUES (6, 'Contact', false, 1)

INSERT INTO TAB_VIEW_SECTIONS (TAB_VIEW_ID, HIDDEN, NAME, TEMPLATE) VALUES (1, false, 'education and training', '<span>lots</span>')
