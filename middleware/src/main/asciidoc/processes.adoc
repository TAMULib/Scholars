...
This will find a list of processes based on the _process ids_ provided as a parameter as shown in *Path Parameters*. The json response will have the specific processes as shown in the *Sample Response*.

===== Path Parameters
include::{snippets}/processes/find-by-id-in/path-parameters.adoc[]
