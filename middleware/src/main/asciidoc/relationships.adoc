...
This will find a list of relationships based on the _relationship ids_ provided as a parameter as shown in *Path Parameters*. The json response will have the specific relationships as shown in the *Sample Response*.

===== Path Parameters
include::{snippets}/relationships/find-by-id-in/path-parameters.adoc[]
