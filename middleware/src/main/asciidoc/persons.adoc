...
This provides a directory listing view of all the persons present in the system, based on the _request paramters_ as shown.
...
This will find a person based on the _person id_ provided as a parameter as shown in *Path Parameters*. The json response will have the specific persons querried as shown in the *Sample Response*.
