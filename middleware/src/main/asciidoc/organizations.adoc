...
This will find a list of organizations based on the _organization ids_ provided as a parameter as shown in *Path Parameters*. The json response will have the specific organizations as shown in the *Sample Response*.

===== Path Parameters
include::{snippets}/organizations/find-by-id-in/path-parameters.adoc[]
