...
This will find a list of documents based on the _document ids_ provided as a parameter as shown in *Path Parameters*. The json response will have the specific documents as shown in the *Sample Response*.

===== Path Parameters
include::{snippets}/documents/find-by-id-in/path-parameters.adoc[]
